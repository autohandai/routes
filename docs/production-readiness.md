...
- Eval, eval-gate, calibration, and scoring optimization commands exist for deterministic router tuning; `examples/eval.production.jsonl` provides a 50-example production gate with minimum tier/domain accuracy thresholds.
